    ...
    <div className='flex items-center justify-between py-2.5 font-medium'>
        ...
        <div className='flex items-center gap-6'>
            ...
            <Link to="/cart" className='relative'>
                ...
                <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white font-size: 0.75rem aspect-square rounded-full text-[-8px] cart-value'>{getCartCount()}</p>
            </Link>
